...
/* Calling LSTM */
float * call_LSTM(float LSTM_input[350]) {

    // First, make tensors
    float LSTM_output_fake[3] = {0};
    k2c_tensor lstm_input_work           = {&LSTM_input[0],2,350,{50, 7, 1, 1, 1}};
        ...
        for(i=0;i<nrun;i++) {
            ...
            while(fabs(x)<=25 && istep<1000000) {
                ...
                if (LSTM_count<LSTM_LEARN) {
                    ...
                    LSTM_input[LSTM_count*LSTM_IN+2] = e0*20.0;
                    LSTM_input[LSTM_count*LSTM_IN+3] = e1*20.0;
                    ...
                    LSTM_input[(LSTM_LEARN-1)*LSTM_IN+2] = e0*20.0;
                    LSTM_input[(LSTM_LEARN-1)*LSTM_IN+3] = e1*20.0;
